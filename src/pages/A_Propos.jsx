    ...
    <div className="About">
        ...
        <div className="Profil">
            <div className="CarteProfil">
                <img src="src/assets/DA/fahed.jpg" alt="Moi" />
            ...
            <div className="ContenuProfil">
                    <div className="Description">
                        ...
                        <p>Depuis le plus jeune âge j'ai été plongé dans <b>l'informatique</b> et le <b>monde d’Internet</b> dans sa globalité ;
                            je passais mes journées devant mon ordinateur à consommer des contenus divers, principalement des jeux vidéos, mais aussi des vidéos Youtube ou d'autres contenus... <br/>alors avec le temps j’ai compris que j'allais finir dans ce vaste milieu plus tard !</p>
                        <p>Mais c'est après quelques mois en BUT Métiers de Multimédia et de l’Internet que j'ai compris que ce qui me correspondait le plus, c'est le développement.
                            J'adore me casser la tête à résoudre des problèmes et développer des solutions à un besoin, et c'est ce qui fait cet amour personnel pour ce domaine en particulier !</p>
